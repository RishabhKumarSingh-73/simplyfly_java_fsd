...
public interface IFlightScheduleService {
    ...
    FlightScheduleResponseDto addFlightSchedule(FlightScheduleCreateDto flightScheduleCreateDTO)throws FlightNotFoundException,RouteNotFoundException,ServiceNotAllowedException;
    FlightScheduleResponseDto updateFlightScheduleStatus(int flightScheduleId, FlightScheduleStatus status)throws FlightScheduleNotFoundException,ServiceNotAllowedException;
    String cancelFlightSchedule(int id)throws FlightScheduleNotFoundException,ServiceNotAllowedException;
